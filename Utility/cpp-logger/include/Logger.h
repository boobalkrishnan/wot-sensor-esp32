...
namespace Logging
{
   ...
   class Logger
   {
      public:
         ...
         void PrintLog(Logging::LogLevel loglevel, const char* Component, const char* LogText, const char* LogText1);
         void PrintLog(Logging::LogLevel loglevel, const char* Component, const char* LogText, int data);
         void PrintLog(Logging::LogLevel loglevel, const char* Component, const char* LogText);
         void PrintLog(Logging::LogLevel loglevel,  const char* Component, int data);
